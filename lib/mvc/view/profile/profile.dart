...
//                               ),
//                              CircleAvatar(
//           backgroundImage: profileUserModel.profileImage != null &&
//                   profileUserModel.profileImage!.isNotEmpty
//               ? NetworkImage(profileUserModel.profileImage!)
...
class Profile extends StatefulWidget {
  const Profile(); // Removed the 'super.key' argument
